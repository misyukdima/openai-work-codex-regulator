...
Определи, нужен ли здесь ChatGPT Work или Codex, проверь quota/runway и сформируй один bounded pass.
...
tests/TEST_CASES.md          regression cases (50)
...
Product/limit/model facts are time-sensitive. `references/SOURCE_MAP.md` records the official OpenAI sources verified for v1.1 (2026-08-22). Account UI always wins for personal remaining usage.
